        ...
        var oTable = $('#testimonial-datatable').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render:function(o){
                        return  `<img src="${o.user_photo}" class="img-sm" onerror="this.src='{{ url('assets/admin/images/default.jpg') }}';"></img>`;
                    }
                },
                {
                    data:  null,
                    ...
                    render:function(o){
						...
						element +=  '@can("testimonial_delete")<button class="btn btn-danger btn-xs" title="Delete" onclick="deleteTestimonial(' + o.id + ')"><i class="fa fa-trash"></i></button>@endcan';
						element +=  '</div>';
                        return element;
                    }
                }
