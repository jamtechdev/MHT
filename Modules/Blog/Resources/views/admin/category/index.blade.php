            ...
            columns: [
                ...
                },
                {
                    ...
                    render:function(o){
						...
						element +=  '@can("blog_category_edit")<a class="btn btn-warning btn-xs me-1" title="Edit" href="{{ $module_route }}/' + o.id + '/edit" ><i class="fa fa-edit"></i></a>@endcan';
						element +=  '@can("blog_category_delete")<button class="btn btn-danger btn-xs me-1" title="Delete" onclick="deleteCategory(' + o.id + ')"><i class="fa fa-trash"></i></button>@endcan';
						element +=  '</div>';
                        return element;
                    }
                }
