    ...
    <section class="maz__error-page">
        <div class="maz__error-bg-image">
            <div class="maz__error-content">
                <span class="maz__error-text">404</span>
                <h3 class="maz__error-info">Oops! That page cannot be found</h3>
                <h5 class="maz__error-msg">We’re sorry, but we can’t seem to find the page you requested. This might be because you have typed the web address incorrectly.</h5>
