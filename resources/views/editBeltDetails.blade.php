            ...
            <div class="row">
                <div class="col-md-11 blue-baner-section">
                    <div class="school-name border">
                        ...
                        <p class="b_portal">Edit your new Belt</p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 mt-4">
                    ...
                    <input type="text" class="form-control input" name="" id="" value="MightyFist">
                </div>
                <div class="col-md-3 mt-4">
                    <label for="enter price">Enter Price:</label>
                    <input type="text" class="form-control input" name="" id="" value="$35.00">
                </div>
                <div class="col-md-3 mt-4">
                    ...
                    <select class="form-select select" aria-label=".form-select-lg example">
                        ...
                        <option value="2" selected>Taekwondo</option>
                ...
                <div class="col-md-3 mt-4">
                    ...
                    <select class="form-select select" aria-label=".form-select-lg example">
                        ...
                        <option value="1" selected>Bronze (Beginner)</option>
            ...
            <div class="row">
                <div class="col-md-12 mt-4">
                    ...
                    <textarea class="form-control textarea" name="" id="" rows="4   " placeholder="Enter Description...">There are three essential skills I will be looking at in this Belification Test: speed, power and technique. This quick test focuses on leg strength, punching speed and balance all three skills canbe evaluated quickly and honestly and are easy to revisit as your training progresses.</textarea>
                </div>
            </div>
                ...
                <div id="myCarousel1" class="carousel slide" data-bs-ride="carousel"> 
                    ...
                    <div class="">
                        ...
                        <a class="carousel-control-next " type="button" href="#myCarousel1"
                            data-bs-target="#myCarousel1" data-bs-slide="next" style="right: -90px">
