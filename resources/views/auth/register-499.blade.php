...
<section class="maz__register maz__sections">
  <div class="container">
    <div class="maz__register-wrapper maz__register-wrapper-plan">
      <form method="POST" action="{{ route('register499') }}" class="maz__register-form" id="register499Form">
        @csrf
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="maz__form-wrapper">
              ...
              <p class="maz__register-text">You're moments away from accessing ~100 FREE martial arts, fitness, yoga, and dance training videos.</p>
