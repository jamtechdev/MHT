...
<section class="maz__register maz__sections">
  <div class="container">
    <div class="maz__register-wrapper maz__register-wrapper-plan">
      <form method="POST" action="{{ route('free') }}" class="maz__register-form" id="freeRegisterForm">
        @csrf
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="maz__form-wrapper">
              ...
              <p class="maz__register-text">You’re moments away from bringing hundreds of workout into your world-phone, TV or computer, anytime, anywhere.</p>
                  ...
                  <div class="col-lg-12 mb-8">
                    <div class="maz__cmn-plan-box">
                        ...
                        <div class="d-flex align-items-center justify-content-start">
                          ...
                          <span class="maz__cmn-plan-price">FREE/Month</span>
                        </div>
