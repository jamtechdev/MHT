                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex  align-items-center justify-content-center">
                                            ...
                                            <form class="checkout_form" action="{{ url('checkoutPlanStripe/'.$planDetails->id) }}">
                                                <input type="hidden" id="form_promocode" name="promocode" value="">
                                                <input type="hidden" id="plan" name="plan" value="{{ $planDetails->id }}">
                                                <input type="hidden" id="price" name="price" value="{{ $planDetails->price }}">
                                                <input type="hidden" name="interval" id="interval" value="lifetime">
                                                <input type="hidden" name="currency" id="currency" value="USD">
                                                <input type="hidden" name="sendUpgradeConfirmEmail" id="sendUpgradeConfirmEmail" value="{{ Session::get("sendUpgradeConfirmEmail") }}">
                                                <button class="btn btn-primary btn-rounded mx-3">Go to checkout</button>
                                            </form>
                                            @if($ifPaymentFail == 0)
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.status == 1)
                        {
                            ...
                            $('.checkout_form #form_promocode').val(promocode);
