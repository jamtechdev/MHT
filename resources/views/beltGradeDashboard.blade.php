                    ...
                    <div class="row">
                        <div class="col-md-12">    
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="card-body alignment" style="padding: 18px 0px;">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>5/4/2021</td>
                    <td><a href="{{ route('beltTestResult') }}" class="btn btn-success" type="button" style="width: 148px;" value="">PASS</a></td>
                  </tr>
                  <tr>
                    <td>Vanessa</td>
                    <td>Lason</td>
