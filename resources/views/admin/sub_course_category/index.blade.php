...
@section('title', 'Sub Course Category')
@section('content')
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5 class="card-title mb-0">Sub Course Category List</h5>
                    <div class="ibox-tools">
                        @can('user_add')
                            <a class="btn btn-primary btn-xs" href="{{ 'coursesubcategory/create' }}" title="Add"><i class="fa fa-plus"></i> Add</a>
                        @endcan
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        var oTable = $('#coursecategory-datatable').DataTable({
			...
			ajax: {
				url: "{!! 'coursesubcategory/datatable' !!}",
				data:function(data) {
				}
			},
            columns: [
                ...
                },
                {
                    ...
                    render:function(o){
						...
						element +=  "<a class='btn btn-warning btn-xs me-1' title='Edit' href='coursesubcategory/" + o.id + "/edit'><i class='fa fa-edit'></i></a>";
                        if(o.isDeleted) {
						    element +=  '<button class="btn btn-danger btn-xs" title="Delete" onclick="deletecourse(' + o.id + ')" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-trash"></i></button>';
                        }
						element +=  '</div>';
						return element;
                    }
