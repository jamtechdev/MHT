    ...
    <div class="maz__dashboard-container">
        <div class="sub-wrapper">
            ...
            <div class="wrapper-content mt-0">
                <h4 class="dashboard_titles">Add Classes</h4>
                <div class="card maz__dashboard__card">
                    <div class="card-body maz__profile-content">
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="POST" id="addClassForm" action=" class="maz__register-form" id="addBiographyVideoForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="maz__question-add-wrapper">
                                        <div class="col-lg-6 mb-3">
                                            <div class="mb-3">
                                                ...
                                                <input id="class_name" type="text" class="form-control @error('title') is-invalid @enderror" name="class_name" value="{{ old('title') ?? '' }}" maxlength="50">
                                        ...
                                        <div class="table-responsive mb-3" id="videos" style="padding:10px;width:100%;" hidden>
                                        ...
                                        <div class="sortVideos mb-2" hidden>
                                            <div class="gallery">
...
<script>
    $(document).ready(function() {
        ...
        //             maxlength: "Class name cannot be more than 50 characters"
        //         },
        //         // description: {
    ...
    $("#discipline").change(function(){
            ...
            $("#videos-datatable").unbind().on('change',"input[type='checkbox']",function(e){
                //  alert($(this).val());
    ...
    //     var rows_selected = $('#videos-datatable').DataTable().column(0).checkboxes.selected();
    ...
    $('#addClassForm').on('submit', function(event){
        ...
        $.ajax({
            url: "{{ route('instructor_post_class') }}",
            type: "POST",
            data:{
