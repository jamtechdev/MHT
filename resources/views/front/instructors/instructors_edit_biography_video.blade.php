    ...
    <div class="maz__dashboard-container">
        <div class="sub-wrapper">
            ...
            <div class="wrapper-content mt-0">
                <h4 class="dashboard_titles">Update Biography Video</h4>
                                ...
                                <form method="POST" action="{{ route('instructor_update_biography') }}" class="maz__register-form" id="addBiographyVideoForm" enctype="multipart/form-data">
                                    ...
                                    <div class="maz__question-add-wrapper">
                                        <div class="mb-3">
                                            ...
                                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $videoData['title']}}" maxlength="50">
                                            @error('title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" rows="3" maxlength="500" name="description">{{ $videoData['description']}}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-5" id="player">
                                            ...
                                            <button type="button" class="btn btn-warning text-uppercase me-3 mt-2" onclick="changeVideo()">Update Biography Video</button>
                                        </div>
