            ...
            <div class="row g-0">
                <div class="col-lg-6">
                    <div class="maz__login-banner">
                        ...
                        <a href="{{ route('instructor_login') }}" class="btn btn-free  btn-rounded btn-info dashboard_btn_info">Explore For Free</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="maz__login-form-wrapper">
                        <a href="{{ route('instructor_login') }}"><img data-src="{{ asset('assets/front/images/logo.svg') }}" class="lazy maz-logo mb-4" alt="logo"></a>
                        <h4 class="maz__login-form-title">Instructor Reset Password</h4>
                    <div>
                    <form class="maz__register-form" method="POST" action="{{ route('post_instructor_reset_password') }}" id="resetPasswordForm">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" required maxlength="200"> --}}
                            @error('email')
