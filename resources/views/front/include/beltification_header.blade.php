...
<section id="sectionRegistrationNotice" class="d-none">
  <div id="registrationNoticeBar" class="bg-secondary text-white d-flex align-items-center justify-content-center">
      <p class="m-4 para"> We noticed that you started signing up but didn't complete your registration. Finish the enrollment process to receive a Special Promotion of $1 Lifetime Access to our future Bronze Level training, learning and certification videos and classes.<a class="text-white" href="{{ route('dashboard')}}"> Continue </a> </p>
      <a href="javascript:void(0);" onclick="event.preventDefault(); $('#registrationNoticeBar').remove();"><i class="fa fa-times text-white txt-edit" aria-hidden="true"></i></a>
  </div>
</section>
@endif
...
<header class="maz__header" id="header-scroll">
  <nav class="navbar navbar-expand-xl navbar-light bg-top">
    <div class="container-fluid g-0">
      ...
      <a class="navbar-brand" href="{{ route('register') }}"><img data-src="{{ asset('assets/front/images/logo.svg') }}" class="lazy" alt="MartialArtZenLogo" width="100%" height="100%"></a>
      @elseif(Session::get('isLandingPage') == 'register499')
      <a class="navbar-brand" href="{{ route('register499') }}"><img data-src="{{ asset('assets/front/images/logo.svg') }}" class="lazy" alt="MartialArtZenLogo" width="100%" height="100%"></a>
      @elseif(Session::get('isLandingPage') == 'free')
      <a class="navbar-brand" href="{{ route('softRegister') }}"><img data-src="{{ asset('assets/front/images/logo.svg') }}" class="lazy" alt="MartialArtZenLogo" width="100%" height="100%"></a>
      @else
      <a class="navbar-brand" href="{{ route('welcome') }}"><img data-src="{{ asset('assets/front/images/logo.svg') }}" class="lazy" alt="MartialArtZenLogo" width="100%" height="100%"></a>
      @endif
        ...
        <div class="offcanvas-body" id="menu-center">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
           ...
           {{-- @if(!Session::get('isLandingPage'))--}}
            ...
            <li class="nav-item">
                <a class="nav-link {{ isActiveRoute(['our-classes']) }}" href="{{ url("our-classes?selIns=All&selDesc=All") }}">Classes</a>
            </li>--}}

            <li class="nav-item">
                <a class="nav-link {{ isActiveRoute(['studentSubmitedTest']) }}" href="{{ route('studentSubmitedTest')}}">For Student</a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ isActiveRoute(['instructorBeltification']) }}" href="{{ route('instructorBeltification')}}">For Instructor</a>
            </li>
