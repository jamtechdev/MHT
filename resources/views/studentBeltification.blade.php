...
<head>
    ...
    <style>
        .backttoschool-wrap .video-play{
    position: relative;
}
.backttoschool-wrap .youtube-btn{
    position: absolute;
    top: 30%;
    left: 25%;
}
            ...
            <div class="row">
                <div class="col-md-11 blue-baner-section">
                    <div class="school-name border">
                        ...
                        <p class="b_portal">View Belt For Student</p>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div >
                                        <img style="width:28%;" src="{{ asset('beltificationimages/Layer_49.png')}}">
                                        <h6 class="text fw-bold" style="font-size: 22px;margin-bottom: 88px;">Taekwondo</h6>
                                        <h6>BELT TEST INTRO VIDEO</h6>
                                        <div class="video-play">
                                            <img class="" style="width: 80%;" src="{{ asset('beltificationimages/Layer_65.png')}}" alt="">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                    <img class="" style="margin-top: 76px; margin-bottom: 88px;" src="{{asset('beltificationimages/5-layers.png')}}">
                                ...
                                <div class="col-md-4 px-5">
                                    ...
                                    <a href="{{ route('submitBeltTest') }}" class="btn btn-success form-control" style="margin-top:80px;margin-bottom: 100px;" type="button" value="SUBMIT MY TEST">TAKE BELTIFICATION TEST</a>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="set-shadow">
                        <h3 class="progress-title text-center">Progress title will come here</h3>
                ...
                <div class="col-md-4" >
                    <!-- <p class="fw-bold text-center">This is cool!</p> -->
                    <a class="btn edit-btn mb-5" href="{{ route('submitBeltTest') }}">GET ME STARTED</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-3 mb-4 mb-lg-0">
                        <img data-src="{{ asset('assets/front/images/lfogo.svg')}}" class="lazy md-fade"
