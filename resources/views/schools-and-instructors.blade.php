                ...
                <div class="container">
                    <div class="swiper__main_blocks">
                        ...
                        <div class="swiper bronze_videos{{ $class_id }} mt-4">
                            <div class="swiper-wrapper bronze_videos1_">
                            @if(count($discipline['instructorData']))
                                @foreach($discipline['instructorData'] as $insFreeData)
                                <div class="swiper-slide">
                                    <a href="{{ route('schools-and-instructors-detail',  $insFreeData['id']) }}">
                                        <div class="maz__swiper_slider_common_block">
                                            <div class="maz__swiper_block_discipline-img">
                                                @if($insFreeData['profile'])
                                                <img src="{{ $insFreeData['profile'] }}"  alt="{{ $insFreeData['name'] }}">
                                                @else
                                                <img src="{{ asset('assets/front/images/avtar.png') }}"  alt="{{ $insFreeData['name'] }}">
                                                @endif
                                                <!-- <div class="Play-btn">
                                            ...
                                            <div class="maz__swiper_block_discipline-content pb-2">
                                                <h6 style="font-weight:600;">{{ $insFreeData['school_name'] }}</h6>
                                ...
                                @php
                                    ...
                                    if($free_count == 0)
                                    {
                                        ...
                                        {
                                            @endphp
                                                <div class="swiper-slide" onclick="registerModal()">
                                                    <div class="maz__swiper_slider_common_block">
                                                        <div class="maz__swiper_block_discipline-img">
...
@push('scripts')
    ...
    <script>
        ...
        for(j=0;j< total_levels; j++){
            var swiper2 = new Swiper(".bronze_videos"+j, {
                slidesPerView: 1,
                spaceBetween: 20,
                cssMode: true,
                navigation: {
